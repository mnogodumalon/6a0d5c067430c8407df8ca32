...
export function MitarbeiterverwaltungDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = true, enablePhotoLocation = true }: MitarbeiterverwaltungDialogProps) {
  ...
  async function handleAiExtract(file?: File) {
    ...
    try {
      ...
      const schema = `{\n  "personalnummer": string | null, // Personalnummer\n  "vorname": string | null, // Vorname\n  "nachname": string | null, // Nachname\n  "position": LookupValue | null, // Position / Rolle (select one key: "drucker" | "projektleitung" | "vertrieb" | "design" | "lager_logistik" | "geschaeftsfuehrung" | "sonstiges") mapping: drucker=Drucker / Druckerin, projektleitung=Projektleitung, vertrieb=Vertrieb, design=Design, lager_logistik=Lager / Logistik, geschaeftsfuehrung=Geschäftsführung, sonstiges=Sonstiges\n  "eintrittsdatum": string | null, // YYYY-MM-DD\n  "email": string | null, // E-Mail-Adresse\n  "telefon": string | null, // Telefonnummer\n  "notizen": string | null, // Notizen\n}`;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'position': (
      <div key="position" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="position"><SelectValue placeholder="Wähle eine Position" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
            <SelectItem value="drucker">Drucker / Druckerin</SelectItem>
    ...
    'eintrittsdatum': (
      <div key="eintrittsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="eintrittsdatum"
          placeholder="Wann tritt der Mitarbeiter ein?"
          mode="date"
    ...
    'email': (
      <div key="email" className="space-y-1.5">
        ...
        <Input
          id="email"
          type="email"
          placeholder="max.mustermann@wandart.de"
          value={fields.email ?? ''}
    ...
    'notizen': (
      <div key="notizen" className="space-y-1.5">
        ...
        <Textarea
          id="notizen"
          placeholder="Qualifikationen, Projekte, Notizen..."
  ...
  const FIELD_LABELS: Record<string, string> = {"personalnummer": "Personalnummer", "vorname": "Vorname", "nachname": "Nachname", "position": "Position / Rolle", "eintrittsdatum": "Eintrittsdatum", "email": "E-Mail-Adresse", "telefon": "Telefonnummer", "notizen": "Notizen"};
