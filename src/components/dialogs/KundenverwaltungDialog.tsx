...
export function KundenverwaltungDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = true, enablePhotoLocation = true }: KundenverwaltungDialogProps) {
  ...
  const FIELD_LABELS: Record<string, string> = {"kundennummer": "Kundennummer", "vorname": "Vorname", "nachname": "Nachname", "firma": "Firma", "email": "E-Mail-Adresse", "telefon": "Telefonnummer", "strasse": "Straße", "hausnummer": "Hausnummer", "plz": "Postleitzahl", "ort": "Ort", "land": "Land", "notizen": "Notizen"};
