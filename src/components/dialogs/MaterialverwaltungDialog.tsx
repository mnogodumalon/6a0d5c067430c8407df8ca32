...
export function MaterialverwaltungDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: MaterialverwaltungDialogProps) {
  ...
  async function handleAiExtract(file?: File) {
    ...
    try {
      ...
      const schema = `{\n  "materialname": string | null, // Materialname\n  "materialtyp": LookupValue | null, // Materialtyp (select one key: "druckfolie" | "druckfarbe" | "grundierung" | "reinigungsmittel" | "verpackungsmaterial" | "sonstiges") mapping: druckfolie=Druckfolie, druckfarbe=Druckfarbe, grundierung=Grundierung, reinigungsmittel=Reinigungsmittel, verpackungsmaterial=Verpackungsmaterial, sonstiges=Sonstiges\n  "einheit": LookupValue | null, // Einheit (select one key: "liter" | "kilogramm" | "meter" | "quadratmeter" | "stueck" | "rolle") mapping: liter=Liter, kilogramm=Kilogramm, meter=Meter, quadratmeter=Quadratmeter, stueck=Stück, rolle=Rolle\n  "lagerbestand": number | null, // Aktueller Lagerbestand\n  "mindestbestand": number | null, // Mindestbestand\n  "lieferant": string | null, // Lieferant\n  "preis_pro_einheit": number | null, // Preis pro Einheit (€)\n  "notizen": string | null, // Notizen\n}`;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
      ...
      <div key="materialtyp" className="space-y-1.5">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="druckfarbe">Druckfarbe</SelectItem>
            <SelectItem value="grundierung">Grundierung</SelectItem>
    ...
    'lagerbestand': (
      <div key="lagerbestand" className="space-y-1.5">
        <Label htmlFor="lagerbestand">Aktueller Lagerbestand</Label>
        <Input
          id="lagerbestand"
          type="number"
          step="any"
  ...
  const FIELD_LABELS: Record<string, string> = {"materialname": "Materialname", "materialtyp": "Materialtyp", "einheit": "Einheit", "lagerbestand": "Aktueller Lagerbestand", "mindestbestand": "Mindestbestand", "lieferant": "Lieferant", "preis_pro_einheit": "Preis pro Einheit (€)", "notizen": "Notizen"};
