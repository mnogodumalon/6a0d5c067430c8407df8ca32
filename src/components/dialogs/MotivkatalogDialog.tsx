...
export function MotivkatalogDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: MotivkatalogDialogProps) {
  ...
  async function handleAiExtract(file?: File) {
    ...
    try {
      ...
      const schema = `{\n  "motivname": string | null, // Motivname\n  "beschreibung": string | null, // Beschreibung\n  "kategorie": LookupValue | null, // Kategorie (select one key: "natur" | "architektur" | "abstrakt" | "tiere" | "menschen_portraet" | "stadtansichten" | "sonstiges") mapping: natur=Natur, architektur=Architektur, abstrakt=Abstrakt, tiere=Tiere, menschen_portraet=Menschen / Porträt, stadtansichten=Stadtansichten, sonstiges=Sonstiges\n  "mindestbreite_cm": number | null, // Mindestbreite (cm)\n  "mindesthoehe_cm": number | null, // Mindesthöhe (cm)\n  "maximalbreite_cm": number | null, // Maximalbreite (cm)\n  "maximalhoehe_cm": number | null, // Maximalhöhe (cm)\n  "basispreis_pro_qm": number | null, // Basispreis pro m² (€)\n  "verfuegbar": boolean | null, // Motiv verfügbar\n}`;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'mindestbreite_cm': (
      <div key="mindestbreite_cm" className="space-y-1.5">
    ...
    'mindesthoehe_cm': (
      <div key="mindesthoehe_cm" className="space-y-1.5">
    ...
    'maximalbreite_cm': (
      <div key="maximalbreite_cm" className="space-y-1.5">
    ...
    'maximalhoehe_cm': (
      <div key="maximalhoehe_cm" className="space-y-1.5">
    ...
    'basispreis_pro_qm': (
      <div key="basispreis_pro_qm" className="space-y-1.5">
  ...
  const FIELD_LABELS: Record<string, string> = {"motivname": "Motivname", "beschreibung": "Beschreibung", "kategorie": "Kategorie", "vorschaubild": "Vorschaubild", "mindestbreite_cm": "Mindestbreite (cm)", "mindesthoehe_cm": "Mindesthöhe (cm)", "maximalbreite_cm": "Maximalbreite (cm)", "maximalhoehe_cm": "Maximalhöhe (cm)", "basispreis_pro_qm": "Basispreis pro m² (€)", "verfuegbar": "Motiv verfügbar"};
  const CURRENCY_KEYS = new Set<string>(["basispreis_pro_qm"]);
