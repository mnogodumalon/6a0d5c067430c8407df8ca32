...
const PROXY_BASE = '';
const APP_ID = '6a0d5bde933c27e481cf9817';
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-card rounded-xl border border-border p-6 shadow-md">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              min={0}
              placeholder=""
              value={fields.lagerbestand ?? ''}
              onChange={e => { const n = e.target.value ? Math.max(0, Number(e.target.value)) : undefined; setFields(f => ({ ...f, lagerbestand: n })); }}
            />
          </div>
          <div className="space-y-2">
